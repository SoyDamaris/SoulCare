...
class SoulCareApp {
    ...
    async saveEmotion() {
        ...
        try {
            ...
            this.emotions.push({ ...emotionEntry, id: Date.now() });
            ...
            this.showSuccess('¡Emoción registrada exitosamente!');
    ...
    createActivityChart() {
        ...
        // Datos de ejemplo para actividades de la semana
        ...
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button id="close-workshop-details" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                    </button>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-xl">
                            <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">⏱️ Duración</h4>
                            <p class="text-blue-700 dark:text-blue-300">${duration} minutos</p>
                        </div>
                        
                        <div class="bg-green-50 dark:bg-green-900 p-4 rounded-xl">
                            <h4 class="font-semibold text-green-800 dark:text-green-200 mb-2">📊 Nivel</h4>
                            <p class="text-green-700 dark:text-green-300">${level}</p>
                        </div>
                        
                        <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-xl">
                            <h4 class="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">⭐ Calificación</h4>
                            <p class="text-yellow-700 dark:text-yellow-300">${rating}/5</p>
                        </div>
                        
                        <div class="bg-purple-50 dark:bg-purple-900 p-4 rounded-xl">
                            <h4 class="font-semibold text-purple-800 dark:text-purple-200 mb-2">👥 Participantes</h4>
                            <p class="text-purple-700 dark:text-purple-300">1,250+</p>
                        </div>
                    </div>
                    
                    <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-xl">
                        <h4 class="font-semibold text-gray-800 dark:text-white mb-3">📋 Contenido del Taller:</h4>
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <button id="close-workshop-details-btn" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                            Cerrar
                        </button>
                    </div>
                </div>
    ...
    showWorkshopModal(id, title, description, duration, icon, level) {
        ...
        modal.className = 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50';
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-6xl w-full mx-4 max-h-[95vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-3xl font-bold text-gray-800 dark:text-white">${title}</h3>
                        <p class="text-gray-600 dark:text-gray-300 mt-2">${description}</p>
                    </div>
                    <button id="close-workshop-modal" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                    </button>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 rounded-xl p-6">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 min-h-[500px]">
                        ...
                        <div class="flex justify-between items-center mt-6">
                            <button id="prev-lesson" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                                ← Anterior
                            </button>
                            
                            <div class="flex items-center space-x-4">
                                <span class="text-sm text-gray-600 dark:text-gray-400" id="lesson-counter">Lección 1 de ${workshopData.lessons.length}</span>
                                <div class="bg-gray-200 dark:bg-gray-600 rounded-full h-2 w-32">
                                    <div id="lesson-progress" class="bg-blue-500 h-2 rounded-full transition-all duration-300" style="width: 0%"></div>
                                </div>
                            </div>
                            
                            <button id="next-lesson" class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition-colors">
                                Siguiente →
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex justify-center space-x-4">
                    <button id="close-workshop-modal-btn" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                        Cerrar Curso
                    </button>
                </div>
            </div>
                ...
                lessons: [
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">¿Qué es la Inteligencia Emocional?</h3>
                            <p class="mb-4">La inteligencia emocional es la capacidad de reconocer, entender y manejar nuestras propias emociones, así como las de los demás.</p>
                    ...
                    },
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">Las 6 Emociones Básicas</h3>
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="bg-red-50 dark:bg-red-900 p-4 rounded-lg text-center">
                                    <div class="text-4xl mb-2">😠</div>
                                    <h4 class="font-semibold">Ira</h4>
                                </div>
                                <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg text-center">
                                    <div class="text-4xl mb-2">😢</div>
                                    <h4 class="font-semibold">Tristeza</h4>
                                </div>
                                <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg text-center">
                                    <div class="text-4xl mb-2">😨</div>
                                    <h4 class="font-semibold">Miedo</h4>
                                </div>
                                <div class="bg-green-50 dark:bg-green-900 p-4 rounded-lg text-center">
                                    <div class="text-4xl mb-2">😊</div>
                                    <h4 class="font-semibold">Alegría</h4>
                                </div>
                            </div>
                            <p class="mb-4">Cada emoción tiene una función específica y nos da información importante sobre nuestras necesidades.</p>
                        `,
                        exercise: {
                            type: 'quiz',
                    ...
                    },
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">Estrategias para Manejar Emociones</h3>
                            <div class="space-y-4">
                                <div class="bg-green-50 dark:bg-green-900 p-4 rounded-lg">
                                    <h4 class="font-semibold text-green-800 dark:text-green-200 mb-2">🌬️ Respiración Profunda</h4>
                                    <p>Inhala por 4 segundos, mantén por 4, exhala por 6. Repite 3 veces.</p>
                                </div>
                                <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
                                    <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">🧘‍♀️ Mindfulness</h4>
                                    <p>Observa tus emociones sin juzgarlas. "Estoy sintiendo ira" en lugar de "Estoy enojado".</p>
                                </div>
                                <div class="bg-purple-50 dark:bg-purple-900 p-4 rounded-lg">
                                    <h4 class="font-semibold text-purple-800 dark:text-purple-200 mb-2">✍️ Diario Emocional</h4>
                                    <p>Escribe sobre tus emociones para entender mejor sus causas y patrones.</p>
                                </div>
                            </div>
                        `,
                        exercise: {
                ...
                lessons: [
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">¿Qué es el Estrés?</h3>
                            <p class="mb-4">El estrés es la respuesta natural de tu cuerpo ante situaciones desafiantes o amenazantes.</p>
                            <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg mb-4">
                                <h4 class="font-semibold mb-2">Tipos de estrés:</h4>
                                <ul class="list-disc list-inside space-y-1">
                    ...
                    },
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">Métodos de Relajación</h3>
                            <div class="space-y-4">
                                <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
                                    <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">🫁 Relajación Progresiva</h4>
                                    <p>Tensa y relaja cada grupo muscular, empezando por los pies hasta la cabeza.</p>
                                </div>
                                <div class="bg-green-50 dark:bg-green-900 p-4 rounded-lg">
                                    <h4 class="font-semibold text-green-800 dark:text-green-200 mb-2">🧘‍♀️ Meditación</h4>
                                    <p>Enfócate en tu respiración y observa tus pensamientos sin juzgarlos.</p>
                                </div>
                            </div>
                        `,
                        exercise: {
                ...
                lessons: [
                    {
                        ...
                        content: `
                            <h3 class="text-2xl font-bold mb-4">¿Qué es la Autoestima?</h3>
                            <p class="mb-4">La autoestima es la valoración que tienes de ti mismo, basada en tus pensamientos, sentimientos y experiencias.</p>
                            <div class="bg-purple-50 dark:bg-purple-900 p-4 rounded-lg mb-4">
                                <h4 class="font-semibold mb-2">Componentes de la autoestima:</h4>
                                <ul class="list-disc list-inside space-y-1">
    ...
    generateLessonsList(lessons) {
        return lessons.map((lesson, index) => `
            <div class="flex items-center p-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors lesson-item" data-lesson="${index}">
                <div class="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-800 flex items-center justify-center mr-3">
                    <span class="text-sm font-semibold text-blue-600 dark:text-blue-300">${index + 1}</span>
                </div>
                <div class="flex-1">
                    <h5 class="font-medium text-gray-800 dark:text-white text-sm">${lesson.title}</h5>
                </div>
                <div class="w-4 h-4 rounded-full bg-gray-200 dark:bg-gray-600 lesson-status" id="status-${index}"></div>
            </div>
        `).join('');
    }
    ...
    generateWorkshopIntro(workshopData) {
        return `
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-4">¡Bienvenido al Curso!</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">${workshopData.description}</p>
                <div class="bg-blue-50 dark:bg-blue-900 p-6 rounded-xl">
                    <h3 class="font-semibold text-blue-800 dark:text-blue-200 mb-2">📋 Lo que aprenderás:</h3>
                    <ul class="text-blue-700 dark:text-blue-300 text-left space-y-1">
        ...
        const updateLesson = (lessonIndex) => {
            if (lessonIndex >= 0 && lessonIndex < workshopData.lessons.length) {
                ...
                contentDiv.innerHTML = `
                    <div class="space-y-6">
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">${lesson.title}</h2>
                        </div>
        ...
        if (exercise.type === 'quiz') {
            return `
                <div class="bg-yellow-50 dark:bg-yellow-900 p-6 rounded-xl">
                    <h4 class="font-semibold text-yellow-800 dark:text-yellow-200 mb-4">🧠 Ejercicio de Comprensión</h4>
                    <p class="mb-4">${exercise.question}</p>
                    <div class="space-y-2">
                        ${exercise.options.map((option, index) => `
                            <label class="flex items-center p-3 bg-white dark:bg-gray-800 rounded-lg cursor-pointer hover:bg-yellow-100 dark:hover:bg-yellow-800 transition-colors">
                                <input type="radio" name="quiz-${lessonIndex}" value="${index}" class="mr-3">
                                <span>${option}</span>
                            </label>
                        `).join('')}
                    </div>
                    <button class="mt-4 bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600 transition-colors" onclick="this.checkQuizAnswer(${lessonIndex}, ${exercise.correct})">
                        Verificar Respuesta
                    </button>
                </div>
            `;
            ...
            return `
                <div class="bg-green-50 dark:bg-green-900 p-6 rounded-xl">
                    <h4 class="font-semibold text-green-800 dark:text-green-200 mb-4">💭 Reflexión Personal</h4>
                    <p class="mb-4">${exercise.question}</p>
                    <div class="space-y-2">
                        ${exercise.options.map((option, index) => `
                            <label class="flex items-center p-3 bg-white dark:bg-gray-800 rounded-lg cursor-pointer hover:bg-green-100 dark:hover:bg-green-800 transition-colors">
            ...
            return `
                <div class="bg-blue-50 dark:bg-blue-900 p-6 rounded-xl">
                    <h4 class="font-semibold text-blue-800 dark:text-blue-200 mb-4">🎯 Ejercicio Práctico</h4>
                    <p class="mb-4">${exercise.question}</p>
                    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg">
                        <p class="text-gray-600 dark:text-gray-300">${exercise.instruction}</p>
                    </div>
                    <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
                        Completar Ejercicio
                    </button>
                </div>
            `;
    ...
    updateLessonStatus(modal, completedLessons) {
        ...
        lessonItems.forEach((item, index) => {
            ...
            if (completedLessons.includes(index)) {
                status.className = 'w-4 h-4 rounded-full bg-green-500';
            } else if (index === 0) {
                status.className = 'w-4 h-4 rounded-full bg-blue-500';
            } else {
                status.className = 'w-4 h-4 rounded-full bg-gray-200 dark:bg-gray-600';
            }
        });
    }
    ...
    completeWorkshop(id, title, modal) {
        ...
        contentDiv.innerHTML = `
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-4">¡Felicitaciones!</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">Has completado exitosamente el curso de ${title}</p>
                <div class="bg-green-50 dark:bg-green-900 p-6 rounded-xl mb-6">
                    <h3 class="font-semibold text-green-800 dark:text-green-200 mb-2">🏆 Logros Desbloqueados:</h3>
                ...
                <button onclick="this.close()" class="bg-green-500 text-white px-8 py-3 rounded-xl font-semibold hover:bg-green-600 transition-colors">
                    Cerrar Curso
                </button>
            </div>
        `;
